/* ==========================================================================
   icd11-data.js — ICD-11 챕터06+07 분류 데이터

   icd11-source/icd11_curated_top_level.json 에서 **생성된 파일**이다.
   원본 JSON을 고쳤으면 이 파일도 다시 생성해야 한다(둘이 어긋나면 화면이
   옛 데이터를 보여준다).

   왜 JSON을 그대로 읽지 않고 JS로 옮겼나:
     기존에는 icd11.js가 fetch로 JSON을 읽었는데, 파일을 브라우저로 직접
     열면(file://) 브라우저가 외부 파일 읽기를 차단해 페이지가 "불러오는 중"
     에서 멈췄다(2026-08-16 실측). 데이터를 일반 스크립트에 담으면 그 제약을
     받지 않는다 — data.js와 같은 방식이다.
     "파일로 열어도 AI 외 전 기능이 동작한다"는 원칙을 지키기 위한 조치다.
   ========================================================================== */

window.ICD11_DATA = {
 "note": "ICD-11 챕터06(정신·행동·신경발달장애)+07(수면-각성장애) 상위 진단명(코드에 점 없는 category)만 추출, 자체 번역(WHO 공식 한국어 번역 없음, 검증 필요). 하위 세분화 코드는 icd11_raw_full.json에 보관, 추후 필요시 확장.",
 "chapters": {
  "06": {
   "Neurodevelopmental disorders": {
    ...
    "items": [
     ...
     },
     {
      ...
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/437815624"
     },
     {
      "code": "6A03",
      "title_en": "Developmental learning disorder",
      "title_kr": "발달성 학습장애",
      "definition_en": "Developmental learning disorder is characterised by significant and persistent difficulties in learning academic skills, which may include reading, writing, or arithmetic. The individual’s performance in the affected academic skill(s) is markedly below what would be expected for chronological age and general level of intellectual functioning, and results in significant impairment in the individual’s academic or occupational functioning. Developmental learning disorder first manifests when academic skills are taught during the early school years. Developmental learning disorder is not due to a disorder of intellectual development, sensory impairment (vision or hearing), neurological or motor disorder, lack of availability of education, lack of proficiency in the language of academic instruction, or psychosocial adversity.",
      "inclusions_en": [],
      "exclusions_en": [
       "Symbolic dysfunctions"
      ],
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/2099676649"
     },
     {
      "code": "6A04",
      "title_en": "Developmental motor coordination disorder",
      "title_kr": "발달성 운동조정장애",
      "definition_en": "Developmental motor coordination disorder is characterised by a significant delay in the acquisition of gross and fine motor skills and impairment in the execution of coordinated motor skills that manifest in clumsiness, slowness, or inaccuracy of motor performance. Coordinated motor skills are markedly below that expected given the individual's chronological age and level of intellectual functioning. Onset of coordinated motor skills difficulties occurs during the developmental period and is typically apparent from early childhood. Coordinated motor skills difficulties cause significant and persistent limitations in functioning (e.g. in activities of daily living, school work, and vocational and leisure activities). Difficulties with coordinated motor skills are not solely attributable to a Disease of the Nervous System, Disease of the Musculoskeletal System or Connective Tissue, sensory impairment, and not better explained by a Disorder of Intellectual Development.",
      "inclusions_en": [
    ...
    "items": [
     {
      ...
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/578635574"
     },
     {
      "code": "6A71",
      "title_en": "Recurrent depressive disorder",
      "title_kr": "재발성 우울장애",
      "definition_en": "Recurrent depressive disorder is characterised by a history of at least two depressive episodes separated by at least several months without significant mood disturbance. A depressive episode is characterised by a period of depressed mood or diminished interest in activities occurring most of the day, nearly every day during a period lasting at least two weeks accompanied by other symptoms such as difficulty concentrating, feelings of worthlessness or excessive or inappropriate guilt, hopelessness, recurrent thoughts of death or suicide, changes in appetite or sleep, psychomotor agitation or retardation, and reduced energy or fatigue. There have never been any prior manic, hypomanic, or mixed episodes, which would indicate the presence of a Bipolar disorder.",
      "inclusions_en": [
      ...
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/1194756772"
     },
     {
      "code": "6A72",
      "title_en": "Dysthymic disorder",
      "title_kr": "기분저하증 (지속성 우울장애)",
      "definition_en": "Dysthymic disorder is characterised by a persistent depressive mood (i.e., lasting 2 years or more), for most of the day, for more days than not. In children and adolescents depressed mood can manifest as pervasive irritability. The depressed mood is accompanied by additional symptoms such as markedly diminished interest or pleasure in activities, reduced concentration and attention or indecisiveness, low self-worth or excessive or inappropriate guilt, hopelessness about the future, disturbed sleep or increased sleep, diminished or increased appetite, or low energy or fatigue. During the first 2 years of the disorder, there has never been a 2-week period during which the number and duration of symptoms were sufficient to meet the diagnostic requirements for a Depressive Episode. There is no history of Manic, Mixed, or Hypomanic Episodes.",
      "inclusions_en": [
       "Dysthymia"
      ],
      "exclusions_en": [
   ...
   "Anxiety or fear-related disorders": {
    ...
    "items": [
     ...
     },
     {
      ...
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/167946871"
     }
    ]
   },
   ...
   "Disorders specifically associated with stress": {
    ...
    "items": [
     ...
     },
     {
      ...
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/264310751"
     },
     {
      "code": "6B44",
      "title_en": "Reactive attachment disorder",
      "title_kr": "반응성애착장애",
      "definition_en": "Reactive attachment disorder is characterised by grossly abnormal attachment behaviours in early childhood, occurring in the context of a history of grossly inadequate child care (e.g., severe neglect, maltreatment, institutional deprivation). Even when an adequate primary caregiver is newly available, the child does not turn to the primary caregiver for comfort, support and nurture, rarely displays security-seeking behaviours towards any adult, and does not respond when comfort is offered. Reactive attachment disorder can only be diagnosed in children, and features of the disorder develop within the first 5 years of life. However, the disorder cannot be diagnosed before the age of 1 year (or a developmental age of less than 9 months), when the capacity for selective attachments may not be fully developed, or in the context of Autism spectrum disorder.",
      "inclusions_en": [],
      "exclusions_en": [
       "Asperger syndrome",
       "disinhibited attachment disorder of childhood"
      ],
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/1867081699"
     },
     {
      "code": "6B45",
      "title_en": "Disinhibited social engagement disorder",
      "title_kr": "탈억제성사회관여장애",
      "definition_en": "Disinhibited social engagement disorder is characterised by grossly abnormal social behaviour, occurring in the context of a history of grossly inadequate child care (e.g., severe neglect, institutional deprivation). The child approaches adults indiscriminately, lacks reticence to approach, will go away with unfamiliar adults, and exhibits overly familiar behaviour towards strangers. Disinhibited social engagement disorder can only be diagnosed in children, and features of the disorder develop within the first 5 years of life. However, the disorder cannot be diagnosed before the age of 1 year (or a developmental age of less than 9 months), when the capacity for selective attachments may not be fully developed, or in the context of Autism spectrum disorder.",
      "inclusions_en": [],
      "exclusions_en": [
       "Asperger syndrome",
       "Adjustment disorder",
      ...
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/467941148"
     }
    ]
   },
    ...
    "items": [
     {
      ...
      "title_en": "Enuresis",
      "title_kr": "유뇨증",
      "definition_en": "Enuresis is the repeated voiding of urine into clothes or bed, which may occur during the day or at night, in an individual who has reached a developmental age when urinary continence is ordinarily expected (5 years). The urinary incontinence may have been present from birth (i.e., an atypical extension of normal infantile incontinence), or may have arisen following a period of acquired bladder control. In most cases, the behaviour is involuntary but in some cases it appears intentional. Enuresis should not be diagnosed if unintentional voiding of urine is due to a health condition that interferes with continence (e.g., diseases of the nervous system or musculoskeletal disorders) or by congenital or acquired abnormalities of the urinary tract.",
      "inclusions_en": [
       "Functional enuresis",
    ...
    "items": [
     {
      ...
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/1676588433"
     },
     {
      "code": "6C41",
      "title_en": "Disorders due to use of cannabis",
      "title_kr": "대마사용에 의한 장애",
      ...
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/1913137404"
     },
     {
      "code": "6C42",
      "title_en": "Disorders due to use of synthetic cannabinoids",
      "title_kr": "합성 카나비노이드 사용에 의한 장애",
      ...
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/804833492"
     },
     {
      "code": "6C43",
      "title_en": "Disorders due to use of opioids",
      "title_kr": "오피오이드사용에 의한 장애",
      ...
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/111507461"
     },
     {
      "code": "6C44",
      "title_en": "Disorders due to use of sedatives, hypnotics or anxiolytics",
      "title_kr": "진정제·수면제 또는 항불안제 사용에 의한 장애",
      ...
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/390325614"
     },
     {
      "code": "6C45",
      "title_en": "Disorders due to use of cocaine",
      "title_kr": "코카인사용에 의한 장애",
      ...
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/1689089786"
     },
     {
      "code": "6C46",
      "title_en": "Disorders due to use of stimulants including amphetamines, methamphetamine or methcathinone",
      "title_kr": "암페타민류(메스암페타민·메스카티논 포함) 흥분제 사용에 의한 장애",
      ...
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/1016273204"
     },
     {
      "code": "6C47",
      "title_en": "Disorders due to use of synthetic cathinones",
      "title_kr": "합성 카티논 사용에 의한 장애",
      ...
      "inclusions_en": [],
      "exclusions_en": [],
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/1605818663"
     },
     {
      "code": "6C48",
      "title_en": "Disorders due to use of caffeine",
      "title_kr": "카페인사용에 의한 장애",
      ...
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/31898480"
     },
     {
      "code": "6C49",
      "title_en": "Disorders due to use of hallucinogens",
      "title_kr": "환각제사용에 의한 장애",
      ...
      "inclusions_en": [],
      "exclusions_en": [],
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/1967909777"
     },
     {
      "code": "6C4A",
      "title_en": "Disorders due to use of nicotine",
      "title_kr": "니코틴사용에 의한 장애",
      ...
      "inclusions_en": [],
      "exclusions_en": [],
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/268445189"
     },
     {
      "code": "6C4B",
      "title_en": "Disorders due to use of volatile inhalants",
      "title_kr": "휘발성 흡입제 사용에 의한 장애",
      ...
      "inclusions_en": [],
      "exclusions_en": [],
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/1835610951"
     },
     {
      "code": "6C4C",
      "title_en": "Disorders due to use of MDMA or related drugs, including MDA",
      "title_kr": "MDMA 등 관련 약물 사용에 의한 장애",
      ...
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/1218193465"
     },
     {
      "code": "6C4D",
      "title_en": "Disorders due to use of dissociative drugs including ketamine and phencyclidine [PCP]",
      "title_kr": "케타민·펜사이클리딘(PCP) 등 해리성 약물 사용에 의한 장애",
      ...
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/470484338"
     },
     {
      "code": "6C4E",
      "title_en": "Disorders due to use of other specified psychoactive substances, including medications",
      "title_kr": "기타 명시된 정신작용물질(의약품 포함) 사용에 의한 장애",
      ...
      "inclusions_en": [],
      "exclusions_en": [],
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/136511187"
     },
     {
      "code": "6C4F",
      "title_en": "Disorders due to use of multiple specified psychoactive substances, including medications",
      "title_kr": "다수의 명시된 정신작용물질(의약품 포함) 사용에 의한 장애",
      ...
      "inclusions_en": [],
      "exclusions_en": [],
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/601226803"
     },
     {
      "code": "6C4G",
      "title_en": "Disorders due to use of unknown or unspecified psychoactive substances",
      "title_kr": "미상 또는 명시되지 않은 정신작용물질 사용에 의한 장애",
      ...
      "inclusions_en": [],
      "exclusions_en": [],
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/1414319298"
     },
     {
      "code": "6C4H",
      "title_en": "Disorders due to use of non-psychoactive substances",
      "title_kr": "비정신작용물질 사용에 의한 장애",
   ...
   "Disorders due to addictive behaviours": {
    ...
    "items": [
     ...
     },
     {
      ...
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/1448597234"
     }
    ]
   },
   ...
   "Paraphilic disorders": {
    ...
    "items": [
     {
      "code": "6D30",
      "title_en": "Exhibitionistic disorder",
      "title_kr": "노출장애",
      "definition_en": "Exhibitionistic disorder is characterised by a sustained, focused and intense pattern of sexual arousal—as manifested by persistent sexual thoughts, fantasies, urges, or behaviours—that involves exposing one’s genitals to an unsuspecting individual in public places, usually without inviting or intending closer contact. In addition, in order for Exhibitionistic Disorder to be diagnosed, the individual must have acted on these thoughts, fantasies or urges or be markedly distressed by them. Exhibitionistic Disorder specifically excludes consensual exhibitionistic behaviours that occur with the consent of the person or persons involved as well as socially sanctioned forms of exhibitionism.",
      "inclusions_en": [],
      "exclusions_en": [],
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/141881468"
     },
     {
      "code": "6D31",
      "title_en": "Voyeuristic disorder",
      "title_kr": "관음장애",
      "definition_en": "Voyeuristic disorder is characterised by a sustained, focused and intense pattern of sexual arousal—as manifested by persistent sexual thoughts, fantasies, urges, or behaviours—that involves observing an unsuspecting individual who is naked, in the process of disrobing, or engaging in sexual activity. In addition, in order for Voyeuristic Disorder to be diagnosed, the individual must have acted on these thoughts, fantasies or urges or be markedly distressed by them. Voyeuristic Disorder specifically excludes consensual voyeuristic behaviours that occur with the consent of the person or persons being observed.",
      "inclusions_en": [],
      "exclusions_en": [],
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/1832861162"
     },
     {
      "code": "6D32",
      "title_en": "Pedophilic disorder",
      "title_kr": "소아성애장애",
      "definition_en": "Pedophilic disorder is characterised by a sustained, focused, and intense pattern of sexual arousal—as manifested by persistent sexual thoughts, fantasies, urges, or behaviours—involving pre-pubertal children. In addition, in order for Pedophilic Disorder to be diagnosed, the individual must have acted on these thoughts, fantasies or urges or be markedly distressed by them. This diagnosis does not apply to sexual behaviours among pre- or post-pubertal children with peers who are close in age.",
      "inclusions_en": [],
      "exclusions_en": [],
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/517058174"
     },
     {
      "code": "6D33",
      "title_en": "Coercive sexual sadism disorder",
      "title_kr": "강압적 성적가학장애",
      "definition_en": "Coercive sexual sadism disorder is characterised by a sustained, focused and intense pattern of sexual arousal—as manifested by persistent sexual thoughts, fantasies, urges or behaviours—that involves the infliction of physical or psychological suffering on a non-consenting person. In addition, in order for Coercive Sexual Sadism Disorder to be diagnosed, the individual must have acted on these thoughts, fantasies or urges or be markedly distressed by them. Coercive Sexual Sadism Disorder specifically excludes consensual sexual sadism and masochism.",
      "inclusions_en": [],
      "exclusions_en": [],
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/1890228613"
     },
     {
      "code": "6D34",
      "title_en": "Frotteuristic disorder",
      "title_kr": "마찰도착장애",
      "definition_en": "Frotteuristic disorder is characterised by a sustained, focused and intense pattern of sexual arousal—as manifested by persistent sexual thoughts, fantasies, urges, or behaviours—that involves touching or rubbing against a non-consenting person in crowded public places. In addition, in order for Frotteuristic Disorder to be diagnosed, the individual must have acted on these thoughts, fantasies or urges or be markedly distressed by them. Frotteuristic Disorder specifically excludes consensual touching or rubbing that occurs with the consent of the person or persons involved.",
      "inclusions_en": [],
      "exclusions_en": [],
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/1580013387"
     },
     {
      "code": "6D35",
      "title_en": "Other paraphilic disorder involving non-consenting individuals",
      "title_kr": "비동의 대상과 관련된 기타 성도착장애",
      "definition_en": "Other paraphilic disorder involving non-consenting individuals is characterised by a persistent and intense pattern of atypical sexual arousal — manifested by sexual thoughts, fantasies, urges, or behaviours — in which the focus of the arousal pattern involves others who are unwilling or unable to consent but that is not specifically described in any of the other named Paraphilic Disorders categories (e.g., arousal patterns involving corpses or animals). The individual must have acted on these thoughts, fantasies or urges or be markedly distressed by them. The disorder specifically excludes sexual behaviours that occur with the consent of the person or persons involved, provided that they are considered able to provide such consent.",
      "inclusions_en": [],
      "exclusions_en": [],
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/1582257458"
     },
     {
      "code": "6D36",
      "title_en": "Paraphilic disorder involving solitary behaviour or consenting individuals",
      "title_kr": "단독행동 또는 동의한 대상과 관련된 성도착장애",
      "definition_en": "Paraphilic disorder involving solitary behaviour or consenting individuals is characterised by a persistent and intense pattern of atypical sexual arousal — manifested by sexual thoughts, fantasies, urges, or behaviours — that involves consenting adults or solitary behaviours. One of the following two elements must be present: 1) the person is markedly distressed by the nature of the arousal pattern and the distress is not simply a consequence of rejection or feared rejection of the arousal pattern by others; or 2) the nature of the paraphilic behaviour involves significant risk of injury or death either to the individual or to the partner (e.g., asphyxophilia).",
      "inclusions_en": [],
      "exclusions_en": [],
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/2055403635"
     }
    ]
   },
   "Factitious disorders": {
   ...
   "Neurocognitive disorders": {
    ...
    "items": [
     ...
     },
     {
      ...
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/386330688"
     }
    ]
   },
   "Dementia": {
    ...
    "items": [
     {
      ...
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/255980141"
     },
     {
      "code": "6E61",
      "title_en": "Secondary psychotic syndrome",
      "title_kr": "이차성 정신병적증후군",
      "definition_en": "A syndrome characterised by the presence of prominent hallucinations or delusions judged to be a direct pathophysiological consequence of a health condition not classified under mental and behavioural disorders, based on evidence from the history, physical examination, or laboratory findings. The symptoms are not accounted for by delirium or by another mental and behavioural disorder, and are not a psychologically mediated response to a severe medical condition (e.g., an acute stress reaction in response to a life-threatening diagnosis). This category should be used in addition to the diagnosis for the presumed underlying disorder or disease when the psychotic symptoms are sufficiently severe to warrant specific clinical attention.",
      "inclusions_en": [],
      "exclusions_en": [
       "Acute and transient psychotic disorder",
       "Delirium",
      ...
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/696956921"
     },
     {
      "code": "6E62",
      "title_en": "Secondary mood syndrome",
      "title_kr": "이차성 기분증후군",
      "definition_en": "A syndrome characterised by the presence of prominent mood symptoms (i.e., depression, elevated mood, irritability) judged to be a direct pathophysiological consequence of a health condition not classified under mental and behavioural disorders, based on evidence from the history, physical examination, or laboratory findings. The symptoms are not accounted for by delirium or by another mental and behavioural disorder, and are not a psychologically mediated response to a severe medical condition (e.g., depressive symptoms in response to a life-threatening diagnosis). This category should be used in addition to the diagnosis for the presumed underlying disorder or disease when the mood symptoms are sufficiently severe to warrant specific clinical attention.",
      "inclusions_en": [],
      "exclusions_en": [
       "Adjustment disorder",
       "Delirium"
      ],
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/216291184"
     },
     {
      "code": "6E63",
      "title_en": "Secondary anxiety syndrome",
      "title_kr": "이차성 불안증후군",
      "definition_en": "A syndrome characterised by the presence of prominent anxiety symptoms judged to be a direct pathophysiological consequence of a health condition not classified under mental and behavioural disorders, based on evidence from the history, physical examination, or laboratory findings. The symptoms are not accounted for by delirium or by another mental and behavioural disorder, and are not a psychologically mediated response to a severe medical condition (e.g., anxiety symptoms or panic attacks in response to a life-threatening diagnosis). This category should be used in addition to the diagnosis for the presumed underlying disorder or disease when the anxiety symptoms are sufficiently severe to warrant specific clinical attention.",
      "inclusions_en": [],
      "exclusions_en": [
       "Adjustment disorder",
       "Delirium"
      ],
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/2131412196"
     },
     {
      "code": "6E64",
      "title_en": "Secondary obsessive-compulsive or related syndrome",
      "title_kr": "이차성 강박 및 관련 증후군",
      "definition_en": "A syndrome characterised by the presence of prominent obsessions, compulsions, hoarding, skin picking, hair pulling, other body-focused repetitive behaviours, or other symptoms characteristic of obsessive-compulsive and related disorder that is judged to be the direct pathophysiological consequence of a disorder or disease not classified under Mental and behavioural disorders, based on evidence from the history, physical examination, or laboratory findings. The symptoms are not accounted for by Delirium or by another Mental and behavioural disorder, and are not a psychologically mediated response to a severe medical condition (e.g., repetitive ruminations in response to a life-threatening diagnosis). This category should be used in addition to the diagnosis for the presumed underlying disorder or disease when the obsessive-compulsive or related symptoms are sufficiently severe to warrant specific clinical attention.",
      "inclusions_en": [],
      "exclusions_en": [
       "Delirium",
     ...
     },
     {
      ...
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/1324394161"
     },
     {
      "code": "6E69",
      "title_en": "Secondary catatonia syndrome",
      "title_kr": "이차성 긴장증후군",
      "definition_en": "Secondary catatonia syndrome is a syndrome of primarily psychomotor disturbances, characterized by the co-occurrence of several symptoms of decreased, increased, or abnormal psychomotor activity, which occurs as a direct pathophysiological consequence of a medical condition not classified under Mental, Behavioural or Neurodevelopmental Disorders. Examples of medical conditions that may be associated with Catatonia include diabetic ketoacidosis, hypercalcaemia, hepatic encephalopathy, homocystinuria, neoplasms head trauma, cerebrovascular disease, and encephalitis.",
      "inclusions_en": [],
      "exclusions_en": [],
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/518306574"
     }
    ]
   }
  },
   ...
   "Hypersomnolence disorders": {
    ...
    "items": [
     ...
     },
     {
      ...
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/1980306606"
     }
    ]
   },
    ...
    "items": [
     {
      ...
      "inclusions_en": [],
      "exclusions_en": [],
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/883900763"
     },
     {
      "code": "7B01",
      "title_en": "Parasomnias related to REM sleep",
      "title_kr": "REM수면관련 사건수면",
      "definition_en": "Parasomnias related to REM (rapid eye movement) sleep are characterised by experiences or behaviours such as vocalization or complex motor behaviours, sleep paralysis, or nightmares that are associated with REM sleep. The experiences are sufficiently severe to result in significant distress or significant impairment in personal, family, social, educational, occupational or other important areas of functioning or significant risk of injury to the individual or to others.",
      "inclusions_en": [],
      "exclusions_en": [],
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/1264934516"
     },
     {
      "code": "7B02",
      "title_en": "Other parasomnias",
      "title_kr": "기타 사건수면",
      "definition_en": "Other parasomnias include Hypnogogic exploding head syndrome, Sleep-related hallucinations, and abnormal sleep related complex movements, behaviours, emotions, perceptions, dreams, or autonomic nervous system activity related to a medical condition or due to a medication or substance. The experiences are sufficiently severe to result in significant distress or significant impairment in personal, family, social, educational, occupational or other important areas of functioning or significant risk of injury to the individual or to others.",
      "inclusions_en": [],
      "exclusions_en": [],
      "uri": "http://id.who.int/icd/release/11/2024-01/mms/192130563"
     }
    ]
   }
  }
